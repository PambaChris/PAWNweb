...
const Footer = () => {
  return (
    <footer className="bg-dark-background text-white pt-12 pb-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="text-light-text hover:text-white">Facebook</a>
            <a href="#" className="text-light-text hover:text-white">Twitter</a>
            <a href="#" className="text-light-text hover:text-white">Instagram</a>
          </div>
        </div>
        <div>
