...
const Footer = () => {
  return (
    <footer className="bg-light-background text-dark-text pt-12 pb-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="text-dark-text hover:text-primary-lilac">Facebook</a>
            <a href="#" className="text-dark-text hover:text-primary-lilac">Twitter</a>
            <a href="#" className="text-dark-text hover:text-primary-lilac">Instagram</a>
          </div>
        </div>
        <div>
          ...
          <form className="flex">
            <input type="email" className="w-full rounded-l-md px-4 py-2 bg-gray-200 text-dark-text" placeholder="Enter your email" />
