            ...
            <form>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                <div className="mb-4">
                  ...
                  <input type="date" id="date" name="date" className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-dark-text focus:outline-none focus:border-secondary-lilac" />
                </div>
                <div className="mb-4">
                  <label htmlFor="time" className="block text-gray-300 mb-2">Preferred Time</label>
                  <input type="time" id="time" name="time" className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-dark-text focus:outline-none focus:border-secondary-lilac" />
                </div>
              </div>
              <div className="mt-4 mb-6">
                <label htmlFor="reason" className="block text-gray-300 mb-2">Reason for Appointment</label>
                <textarea id="reason" name="reason" rows={5} className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-dark-text focus:outline-none focus:border-secondary-lilac"></textarea>
              </div>
