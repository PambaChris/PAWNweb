      ...
      <section className="py-20 bg-dark-background">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-primary-lilac">Appointment Details</h2>
            <form>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                <div className="mb-4">
                  ...
                  <input type="date" id="date" name="date" className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-light-text focus:outline-none focus:border-secondary-lilac" />
                </div>
                <div className="mb-4">
                  <label htmlFor="time" className="block text-gray-300 mb-2">Preferred Time</label>
                  <input type="time" id="time" name="time" className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-light-text focus:outline-none focus:border-secondary-lilac" />
                </div>
              </div>
              <div className="mt-4 mb-6">
                <label htmlFor="reason" className="block text-gray-300 mb-2">Reason for Appointment</label>
                <textarea id="reason" name="reason" rows={5} className="w-full bg-gray-200 border border-gray-300 rounded-lg py-2 px-4 text-light-text focus:outline-none focus:border-secondary-lilac"></textarea>
              </div>
