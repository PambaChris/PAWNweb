...
const NewsPage = () => {
  ...
  return (
    <>
      {/* Page Header */}
      <header className="bg-panafrican-yellow py-16">
        <div className="container mx-auto px-4 text-center text-panafrican-black">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                {articles.map((article, index) => (
                  <div key={index} className="bg-gray-900 rounded-lg shadow-lg overflow-hidden md:flex">
                    ...
                    <div className="p-8 md:w-2/3">
                      <p className="text-sm text-panafrican-yellow mb-2">{article.category}</p>
                      ...
                      <Link href="#" className="text-panafrican-green hover:underline font-semibold">
                        Read More &rarr;
                      </Link>
                    </div>
                  </div>
            ...
            <aside>
              <div className="bg-gray-900 p-8 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold mb-6 text-panafrican-red">Categories</h3>
                <ul className="space-y-3 text-gray-300">
                  <li><a href="#" className="hover:text-panafrican-yellow">Network News</a></li>
              ...
              <div className="bg-gray-900 p-8 rounded-lg shadow-lg mt-8">
                <h3 className="text-xl font-bold mb-6 text-panafrican-red">Recent Posts</h3>
                <ul className="space-y-4">
                  {articles.slice(0, 3).map((article, index) => (
                    <li key={index}>
                      <Link href="#" className="text-gray-300 hover:text-panafrican-yellow">
                        {article.title}
                      </Link>
                    </li>
                  ))}
